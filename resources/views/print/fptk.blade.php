...
<body>
                ...
                <tbody>
                    <tr>
                        <td class="text-left" width="20%">
                            <img src="{{ asset('favicon.png') }}" alt="AVI Logo" style="max-height: 40px; width: auto;">
                        </td>
    ...
    <section id="body-of-report">
        <div class="container-fluid">
                    ...
                    <tr>
                        ...
                        <td style="width: 50%; vertical-align: top; padding: 10px;">
                            ...
                            <div class="flex-row">
                                ...
                                <div class="col-colon">:</div>
                                <div class="col-value">{{ $requisition->department }}</div>
                            </div>
                            <div class="flex-row">
                                <div class="col-label">Section</div>
                                <div class="col-colon">:</div>
                                <div class="col-value">{{ $requisition->section }}</div>
                            </div>
                            <div class="flex-row">
                                <div class="col-label">Position</div>
                                <div class="col-colon">:</div>
                                <div class="col-value">{{ $requisition->position }}</div>
                            </div>
                            <div class="flex-row">
                                <div class="col-label">Status</div>
                                <div class="col-colon">:</div>
                                <div class="col-value">{{ $requisition->status ?: '-' }}</div>
                            </div>
                            <div class="flex-row">
                                <div class="col-label">Duration (contract/intern)</div>
                                <div class="col-colon">:</div>
                                <div class="col-value">{{ $requisition->duration }} Month(s)</div>
                            </div>
                            <div class="flex-row">
                                <div class="col-label">Level</div>
                                <div class="col-colon">:</div>
                                <div class="col-value">{{ $requisition->level }}</div>
                            </div>
                            <div class="flex-row">
                                <div class="col-label">Number Of Employee</div>
                                <div class="col-colon">:</div>
                                <div class="col-value">{{ $requisition->cost_employee }}</div>
                            </div>
                            <div class="flex-row">
                                <div class="col-label">Start Date Required</div>
                                <div class="col-colon">:</div>
                                <div class="col-value">
                                    {{ $requisition->fulfilment_time ? \Carbon\Carbon::parse($requisition->fulfilment_time)->format('d-F-Y') : '-' }}
                                </div>
                            </div>
                            ...
                            <div class="flex-row">
                                <div class="col-label">Education / Major</div>
                                <div class="col-colon">:</div>
                        ...
                        <td style="width: 50%; vertical-align: top; padding: 10px;">
                            ...
                            <div class="flex-row">
                                <div class="col-label" style="width: 30%">Technical Skill</div>
                            ...
                            <br>
                            <div class="flex-row">
                                <div class="col-label" style="width: 30%">Soft Skill</div>
                                <div class="col-colon" style="width: 5%">:</div>
                                <div class="col-value" style="width: 65%">
            ...
            <h5 style="margin-top: 20px; font-size: 13px;">Cibinong,
                {{ $requisition->request_date ? \Carbon\Carbon::parse($requisition->request_date)->format('d-F-Y') : '-' }}
            </h5>
                    ...
                    <tr>
                        <td style="width: 33.33%; padding: 10px; text-align: center;">
                            ...
                            <div style="margin-top: 5px;">Date:
                                {{ $requisition->request_date ? \Carbon\Carbon::parse($requisition->request_date)->format('d-m-Y') : '-' }}
                            </div>
                        </td>
                        <td style="width: 33.33%; padding: 10px; text-align: center;">
            ...
            <div style="margin-top: 30px; font-size: 11px; font-style: italic;">
                *Form ini dicetak oleh sistem dan tidak memerlukan tanda tangan basah atau pengesahan lain jika sudah
                berstatus Approved.
            </div>
        </div>
    </section>
